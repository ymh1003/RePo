...
// #   define d_m3MaxFunctionStackHeight           2000    // max: 32768
    #   define d_m3MaxFunctionStackHeight           10000    // max: 32768
# endif
...
// New
#if defined(USE_MPFR) || defined(USE_MPFR_DD) || defined(USE_QD) || \
    defined(USE_EID)  || defined(USE_DD)      || defined(USE_EFTSAN)
#   define d_m3HasErrorSlot                     1
#else
#   define d_m3HasErrorSlot                     0
#endif
